...
fp_header = open("fmx10_parameters.h", "w")
fp_src = open("fmx10_parameters.c", "w")
...
extern const struct fmx10_parameters_t fmx10_parameters;
"""
...
#endif
struct fmx10_parameters_t fmx10_parameters = {
"""
i=0
for group in root:
	if group.tag == "group" and "no_code_generation" not in group.attrib:
